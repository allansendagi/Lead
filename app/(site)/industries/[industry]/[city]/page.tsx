        ...
        >
          ...
          <div>
            ...
            <div className="cta-box" style={{ margin: '32px 0' }}>
              <CTAButton href="/assessment" location={`industry_mid_${indSlug}_${citySlug}`} />
            </div>
            ...
            <div className="cta-box">
              ...
              <CTAButton href="/assessment" location={`industry_cta_${indSlug}_${citySlug}`} />
            </div>
            ...
            <div className="author-bio">
              ...
              <p style={{ marginTop: 8 }}>
                <a href="/assessment" style={{ color: 'var(--brand)', fontWeight: 600 }}>
