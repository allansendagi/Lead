...
const WA_MSG = encodeURIComponent("Hi Allan, I'm interested in the AI Navigator framework")
  ...
  return (
    <>
      <a
        ...
        aria-label="Chat with Allan on WhatsApp"
        onClick={() => {
      ...
      >
        ...
        <span className="wa-label">Chat with Allan</span>
      </a>
      <style>{`
        @media (max-width: 640px) {
          .wa-label { display: none; }
          a[aria-label="Chat with Allan on WhatsApp"] {
